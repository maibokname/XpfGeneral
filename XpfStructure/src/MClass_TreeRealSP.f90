...
!   type uses the Fortran intrinsic *REAL(KIND=kSingle)* type as the type of its stored keys
...
#define KeyTypeC        REAL(KIND=kSingle)
...
!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_TreeRealSP'
