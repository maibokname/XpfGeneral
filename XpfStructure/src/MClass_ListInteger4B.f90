...
MODULE MClass_ListInteger4B

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *ListInteger4B* type and related routines.
...
#define DblLnkList          ListInteger4B
#define DLLNode             DLLNodeInteger4B
#define ItemTypeA           INTEGER(KIND=kInt32)
#define ItemTypeB           INTEGER(KIND=kInt32)
#define ItemTypeC           INTEGER(KIND=kInt32)
#define TypeOfItem          INTEGER(KIND=kInt32)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_ListInteger4B'
...
END MODULE MClass_ListInteger4B
