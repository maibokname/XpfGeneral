...
MODULE MClass_TreeRealQP

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *TreeRealQP* type and its related helper type and routines.
...
!   operations for an ordered symbol table.  As an ordered symbol table, the *TreeRealQP*
!   type uses the Fortran intrinsic *REAL(KIND=kQuad)* type as the type of its stored keys
!   and an unlimited polymorphic type as the type of its stored values. <br>
!   As a symbol table, the *TreeRealQP* type does not allow duplicated keys.  Therefore,
...
!   *TreeRealQP* type employs a left-leaning red-black (RB) tree as the balanced BST. <br>
...
#define KeyTypeA        REAL(KIND=kQuad)
#define KeyTypeB        REAL(KIND=kQuad)
#define KeyTypeC        REAL(KIND=kQuad)
#define QueueKey        ListRealQP
#define QueueVal        ListAnyType
#define RedBlackTree    TreeRealQP

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_TreeRealQP'
