...
MODULE MClass_PQRealDP

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *PQRealDP* type and its related routines.
!   The *PQRealDP* type is a priority-queue container with *REAL(KIND=kDouble)*
...
#define     KeyType     REAL(KIND=kDouble)
#define     PQHeap      PQRealDP

!** MODULE PARAMETERS:
    tCharStar, PARAMETER    :: ModName = 'MClass_PQRealDP'
