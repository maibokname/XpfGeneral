...
MODULE MClass_PQInteger2B

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *PQInteger2B* type and its related routines.
!   The *PQInteger2B* type is a priority-queue container with *INTEGER(KIND=kInt16)*
...
#define     KeyType     INTEGER(KIND=kInt16)
#define     PQHeap      PQInteger2B

!** MODULE PARAMETERS:
    tCharStar, PARAMETER    :: ModName = 'MClass_PQInteger2B'
