...
MODULE MClass_DArrCmpxDP

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *DArrCmpxDP* type and related routines.
...
!   employed by the *DArrCmpxDP* type. <br>
...
#define DynArr          DArrCmpxDP
#define TypeAlloc       COMPLEX(KIND=kDouble), ALLOCATABLE
#define TypeArgmt       COMPLEX(KIND=kDouble)
#define TypeOfItem      COMPLEX(KIND=kDouble)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_DArrCmpxDP'
