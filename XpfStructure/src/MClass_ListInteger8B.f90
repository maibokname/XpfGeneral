...
#define ItemTypeA           INTEGER(KIND=kInt64)
#define ItemTypeB           INTEGER(KIND=kInt64)
#define ItemTypeC           INTEGER(KIND=kInt64)
#define TypeOfItem          INTEGER(KIND=kInt64)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_ListInteger8B'
...
END MODULE MClass_ListInteger8B
