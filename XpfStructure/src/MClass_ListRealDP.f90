...
#define ItemTypeA           REAL(KIND=kDouble)
#define ItemTypeB           REAL(KIND=kDouble)
#define ItemTypeC           REAL(KIND=kDouble)
#define TypeOfItem          REAL(KIND=kDouble)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_ListRealDP'
