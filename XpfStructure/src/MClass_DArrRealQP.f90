...
#define TypeAlloc       REAL(KIND=kQuad), ALLOCATABLE
#define TypeArgmt       REAL(KIND=kQuad)
#define TypeOfItem      REAL(KIND=kQuad)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_DArrRealQP'
