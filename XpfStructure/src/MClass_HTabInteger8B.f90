...
MODULE MClass_HTabInteger8B

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *HTabInteger8B* type, the *TabItem* type and their
...
!   As an unordered symbol table, the *HTabInteger8B* type uses the Fortran intrinsic
!   *INTEGER(KIND=kInt64)* type as the type of its stored keys and an unlimited polymorphic type
...
!   Technically, the *HTabInteger8B* type employs the open-addressing as a collision
...
#define     tHash           tIndex
!----------------------------------------------------------
#define     HashTable       HTabInteger8B
#define     KeyTypeA        INTEGER(KIND=kInt64)
#define     KeyTypeB        INTEGER(KIND=kInt64)
...
!** ACCESSIBLE SPECIFICATIONS OF MODULE DATA, SUBROUTINES OR FUNCTONS
    PUBLIC :: HTabInteger8B

    PRIVATE          ! by default, hide all data and routines except those declared explicitly

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_HTabInteger8B'
    ! Special marker token used to indicate the deletion of a key-value pair
    tSInt64,   PARAMETER    :: DELKEY = ToInt64(Z'7FFFFFFFFFFFFFFF')
    ! Special marker token used to indicate the empty of a key-value pair
    tSInt64,   PARAMETER    :: NULKEY = ToInt64(Z'8000000000000000')
...
END MODULE MClass_HTabInteger8B
