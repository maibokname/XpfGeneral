...
MODULE MClass_HTabInteger4B

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *HTabInteger4B* type, the *TabItem* type and their
...
!   As an unordered symbol table, the *HTabInteger4B* type uses the Fortran intrinsic
!   *INTEGER(KIND=kInt32)* type as the type of its stored keys and an unlimited polymorphic type
...
!   Technically, the *HTabInteger4B* type employs the open-addressing as a collision
...
#define     tHash           tIndex
!----------------------------------------------------------
#define     HashTable       HTabInteger4B
...
!** ACCESSIBLE SPECIFICATIONS OF MODULE DATA, SUBROUTINES OR FUNCTONS
    PUBLIC :: HTabInteger4B

    PRIVATE          ! by default, hide all data and routines except those declared explicitly

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_HTabInteger4B'
    ! Special marker token used to indicate the deletion of a key-value pair
    tSInt32,   PARAMETER    :: DELKEY = ToInt32(Z'7FFFFFFF')
    ! Special marker token used to indicate the empty of a key-value pair
    tSInt32,   PARAMETER    :: NULKEY = ToInt32(Z'80000000')
...
END MODULE MClass_HTabInteger4B
