...
MODULE MClass_ListRealQP

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *ListRealQP* type and related routines.
...
#define DblLnkList          ListRealQP
#define DLLNode             DLLNodeRealQP
#define ItemTypeA           REAL(KIND=kQuad)
#define ItemTypeB           REAL(KIND=kQuad)
#define ItemTypeC           REAL(KIND=kQuad)
#define TypeOfItem          REAL(KIND=kQuad)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_ListRealQP'
