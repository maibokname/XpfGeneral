...
#define TypeAlloc       INTEGER(KIND=kInt64), ALLOCATABLE
#define TypeArgmt       INTEGER(KIND=kInt64)
#define TypeOfItem      INTEGER(KIND=kInt64)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_DArrInteger8B'
...
END MODULE MClass_DArrInteger8B
