...
MODULE MClass_ListInteger1B

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *ListInteger1B* type and related routines.
...
#define DblLnkList          ListInteger1B
#define DLLNode             DLLNodeInteger1B
#define ItemTypeA           INTEGER(KIND=kInt8)
#define ItemTypeB           INTEGER(KIND=kInt8)
#define ItemTypeC           INTEGER(KIND=kInt8)
#define TypeOfItem          INTEGER(KIND=kInt8)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_ListInteger1B'
...
END MODULE MClass_ListInteger1B
