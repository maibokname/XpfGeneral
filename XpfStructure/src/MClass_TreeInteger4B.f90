...
MODULE MClass_TreeInteger4B

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *TreeInteger4B* type and its related helper type and routines.
...
!   operations for an ordered symbol table.  As an ordered symbol table, the *TreeInteger4B*
!   type uses the Fortran intrinsic *INTEGER(KIND=kInt32)* type as the type of its stored keys
!   and an unlimited polymorphic type as the type of its stored values. <br>
!   As a symbol table, the *TreeInteger4B* type does not allow duplicated keys.  Therefore,
...
!   *TreeInteger4B* type employs a left-leaning red-black (RB) tree as the balanced BST. <br>
...
#define KeyTypeA        INTEGER(KIND=kInt32)
#define KeyTypeB        INTEGER(KIND=kInt32)
#define KeyTypeC        INTEGER(KIND=kInt32)
#define QueueKey        ListInteger4B
#define QueueVal        ListAnyType
#define RedBlackTree    TreeInteger4B

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_TreeInteger4B'
...
END MODULE MClass_TreeInteger4B
