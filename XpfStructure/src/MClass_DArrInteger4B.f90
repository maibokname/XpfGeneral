...
MODULE MClass_DArrInteger4B

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *DArrInteger4B* type and related routines.
...
!   employed by the *DArrInteger4B* type. <br>
...
!** ACCESSIBLE SPECIFICATIONS OF MODULE DATA, SUBROUTINES OR FUNCTONS
    PUBLIC :: DArrInteger4B

    PRIVATE          ! by default, hide all data and routines except those declared explicitly

!*** MACRO DEFINITIONS:
#include    "../../../MacroDef/Macro - Basic Definitions.f90"
#define DynArr          DArrInteger4B
#define TypeAlloc       INTEGER(KIND=kInt32), ALLOCATABLE
#define TypeArgmt       INTEGER(KIND=kInt32)
#define TypeOfItem      INTEGER(KIND=kInt32)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_DArrInteger4B'
...
END MODULE MClass_DArrInteger4B
