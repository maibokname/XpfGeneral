...
MODULE MClass_TreeCharacter

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *TreeCharacter* type and its related helper type and routines.
...
!   operations for an ordered symbol table.  As an ordered symbol table, the *TreeCharacter*
!   type uses the Fortran intrinsic *CHARACTER* type as the type of its stored keys and an
!   unlimited polymorphic type as the type of its stored values. <br>
!   As a symbol table, the *TreeCharacter* type does not allow duplicated keys.  Therefore,
...
!   *TreeCharacter* type employs a left-leaning red-black (RB) tree as the balanced BST. <br>
...
#define KeyTypeC        CHARACTER(LEN=:)
#define QueueKey        ListCharacter
#define QueueVal        ListAnyType
#define RedBlackTree    TreeCharacter

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_TreeCharacter'
...
END MODULE MClass_TreeCharacter
