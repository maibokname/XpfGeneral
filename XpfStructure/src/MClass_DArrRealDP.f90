...
#define TypeAlloc       REAL(KIND=kDouble), ALLOCATABLE
#define TypeArgmt       REAL(KIND=kDouble)
#define TypeOfItem      REAL(KIND=kDouble)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_DArrRealDP'
