...
MODULE MClass_ListLogical

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *ListLogical* type and related routines.
...
#define IS_EQUAL(A, B)      (A .EQV. B)
#define DblLnkList          ListLogical
#define DLLNode             DLLNodeLogical
#define ItemTypeA           LOGICAL
#define ItemTypeB           LOGICAL
#define ItemTypeC           LOGICAL
#define TypeOfItem          LOGICAL

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_ListLogical'
