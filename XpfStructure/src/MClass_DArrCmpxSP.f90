...
MODULE MClass_DArrCmpxSP

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *DArrCmpxSP* type and related routines.
...
!   employed by the *DArrCmpxSP* type. <br>
...
#define DynArr          DArrCmpxSP
#define TypeAlloc       COMPLEX(KIND=kSingle), ALLOCATABLE
#define TypeArgmt       COMPLEX(KIND=kSingle)
#define TypeOfItem      COMPLEX(KIND=kSingle)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_DArrCmpxSP'
