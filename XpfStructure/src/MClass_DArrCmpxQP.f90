...
MODULE MClass_DArrCmpxQP

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *DArrCmpxQP* type and related routines.
...
!   employed by the *DArrCmpxQP* type. <br>
...
#define DynArr          DArrCmpxQP
#define TypeAlloc       COMPLEX(KIND=kQuad), ALLOCATABLE
#define TypeArgmt       COMPLEX(KIND=kQuad)
#define TypeOfItem      COMPLEX(KIND=kQuad)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_DArrCmpxQP'
