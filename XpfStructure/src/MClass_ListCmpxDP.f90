...
MODULE MClass_ListCmpxDP

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *ListCmpxDP* type and related routines.
...
#define DblLnkList          ListCmpxDP
#define DLLNode             DLLNodeCmpxDP
#define ItemTypeA           COMPLEX(KIND=kDouble)
#define ItemTypeB           COMPLEX(KIND=kDouble)
#define ItemTypeC           COMPLEX(KIND=kDouble)
#define TypeOfItem          COMPLEX(KIND=kDouble)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_ListCmpxDP'
