...
!   type uses the Fortran intrinsic *INTEGER(KIND=kInt64)* type as the type of its stored keys
...
#define KeyTypeC        INTEGER(KIND=kInt64)
...
!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_TreeInteger8B'
...
END MODULE MClass_TreeInteger8B
