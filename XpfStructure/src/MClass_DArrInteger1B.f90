...
MODULE MClass_DArrInteger1B

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *DArrInteger1B* type and related routines.
...
!   employed by the *DArrInteger1B* type. <br>
...
!** ACCESSIBLE SPECIFICATIONS OF MODULE DATA, SUBROUTINES OR FUNCTONS
    PUBLIC :: DArrInteger1B

    PRIVATE          ! by default, hide all data and routines except those declared explicitly

!*** MACRO DEFINITIONS:
#include    "../../../MacroDef/Macro - Basic Definitions.f90"
#define DynArr          DArrInteger1B
#define TypeAlloc       INTEGER(KIND=kInt8), ALLOCATABLE
#define TypeArgmt       INTEGER(KIND=kInt8)
#define TypeOfItem      INTEGER(KIND=kInt8)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'MClass_DArrInteger1B'
...
END MODULE MClass_DArrInteger1B
