...
MODULE MClass_PQInteger4B

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *PQInteger4B* type and its related routines.
!   The *PQInteger4B* type is a priority-queue container with *INTEGER(KIND=kInt32)*
!   as the type of its stored keys.  It employs a binary heap implementation
!   to order its stored keys. <br>
!   The *PQInteger4B* type can represent either the max-priority queue or the
...
#define     KeyType     INTEGER(KIND=kInt32)
#define     PQHeap      PQInteger4B

!** MODULE PARAMETERS:
    tCharStar, PARAMETER    :: ModName = 'MClass_PQInteger4B'
