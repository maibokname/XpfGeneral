...
!   This module contains the *SHA1* type and its related routines.
!   The *SHA1* type is a *digest* type that directly extends from the
...
!   The *SHA1* type implements an incremental cryptographic hash
...
!** DERIVED TYPE DEFINITIONS
    ...
    CONTAINS
        ...
        PROCEDURE       :: Initialize   => SHA1_Initialize
        ...
        PROCEDURE       :: GetClone         => SHA1_GetClone
        !> **Type-Bound Function**: GetName <br>
        !  **Purpose**:  To get the name of the *digest* object. <br>
        !  **Usage**: <br>
        !   --->    Name = MD%GetName()
        PROCEDURE       :: GetName          => SHA1_GetName
...
SUBROUTINE SHA1_Initialize(MD)

!** PURPOSE OF THIS SUBROUTINE:
    !^ To perform initialization of the digest object.

!** SUBROUTINE ARGUMENT DECLARATIONS:
    CLASS(SHA1), INTENT(INOUT) :: MD    !! 'SHA1' object
...
END SUBROUTINE SHA1_Initialize

!******************************************************************************

SUBROUTINE SHA1_Reset(MD)
...
SUBROUTINE SHA1_GetClone(Src, Dst)

!** PURPOSE OF THIS SUBROUTINE:
    !^ To clone the current state of the source object.

!** SUBROUTINE ARGUMENT DECLARATIONS:
    CLASS(SHA1),                    INTENT(INOUT)   :: Src !! a source object
...
END SUBROUTINE SHA1_GetClone

!******************************************************************************

FUNCTION SHA1_GetName(MD) RESULT(Name)

!** PURPOSE OF THIS SUBROUTINE:
    !^ To return the algorithm name of the hash function.
        
!** SUBROUTINE ARGUMENT DECLARATIONS:
    CLASS(SHA1), INTENT(IN) :: MD       !! 'SHA1' object
...
END FUNCTION SHA1_GetName

!******************************************************************************

FUNCTION SHA1_GetDigestLen(MD) RESULT(Length)
...
END FUNCTION SHA1_GetDigestLen

!******************************************************************************

FUNCTION SHA1_GetBlockLen(MD) RESULT(Length)
...
END FUNCTION SHA1_GetBlockLen

!******************************************************************************

SUBROUTINE SHA1_SetBufPtr(MD, BufPtr)

!** PURPOSE OF THIS SUBROUTINE:
    !^ To set the pointer *BufPtr* to the actual buffer array with starting index of zero.

!** SUBROUTINE ARGUMENT DECLARATIONS:
    CLASS(SHA1), TARGET, INTENT(INOUT)  :: MD           !! 'SHA1' object
...
END SUBROUTINE SHA1_SetBufPtr

!******************************************************************************

SUBROUTINE SHA1_ProcessBlock(MD, BytesIn)
...
#define XOR_N_ROT(A, B, C, D)   RotateLeft(XOR4(A, B, C, D), 1)
...
END SUBROUTINE SHA1_ProcessBlock

!******************************************************************************

SUBROUTINE SHA1_DoPadding(MD, BytesOut, Offset)
...
END SUBROUTINE SHA1_DoPadding

!******************************************************************************

SUBROUTINE SHA1_AddBitsNPad(MD, LastByte, NBits, BytesOut, Offset)
...
! FLOW
    ...
    ! SHA-1 algorithm does not handle partial bytes
    CALL MD%DoPadding(BytesOut, Offset)
    ASSOCIATE(Dummy => LastByte, Dummy2 => NBits); END ASSOCIATE

    RETURN

END SUBROUTINE SHA1_AddBitsNPad

!******************************************************************************

END MODULE MClass_SHA1
